...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
        <header class="w3-container w3-padding-32 w3-center" id="home">
            <h1>
                <img src="../img/Enlatados.png" alt="Logo" class="w3-image" width="20%">
                <br>
            </h1>
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
            ...
            <form action="/projeto_final/Controller/Navegacao.php" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:100%">
		...
		<form action="/projeto_final/Controller/Navegacao.php" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:100%;">
			...
			<div class="w3-row w3-section">
				...
				<div class="w3-rest">
					<input class="w3-input w3-border w3-round-large" name="txtDescOF" type="text" placeholder="Descrição: Ex.: Curso de Inglês - 200 horas">
				</div>
			</div>
			<div class="w3-row w3-section">
				<div class="w3-center" style="">
