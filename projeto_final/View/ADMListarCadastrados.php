                ...
                if($results != null)
                    while($row = $results->fetch_object()) {
                        ...
                        echo '<td style="width: 20%;">
                                <form action="/projeto_final/Controller/Navegacao.php" method="post" style="display: inline;">
                                    <input type="hidden" name="idUsuario" value="'.$row->idusuario.'">
                                    <button name="btnVisualizarCadastro" class="w3-button w3-blue w3-round-large w3-small">
